...
/**
 * Example5f describes how to execute a SPARQL query using an asserted only 
 * policy.
 * 
 * <p> Query execution in the Jena adapter for Oracle NoSQL database provides 
 * additional performance features such as an asserted only policy
 * used in query execution. 
 * 
 * <p> This feature is specified as a hint in the ORACLE_SEM_FS_NS namespace 
 * as <em>asserted_only</em>, and establishes that the SPARQL query should 
 * retrieve only asserted triple/quads.
 * 
 */

public class Example5f
{
